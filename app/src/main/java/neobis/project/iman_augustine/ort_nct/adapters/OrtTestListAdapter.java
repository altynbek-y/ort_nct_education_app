...
public class OrtTestListAdapter extends RecyclerView.Adapter<OrtTestListAdapter.SubjectViewHolder> {
    private List<SubjectTest> subjectTests;
    private OnItemListener onItemListener;
    private Context context;

    public OrtTestListAdapter(List<SubjectTest> subjectTests, OrtTestListAdapter.OnItemListener onItemListener, Context context) {
